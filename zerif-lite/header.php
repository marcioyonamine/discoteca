...
<link rel="shortcut icon" type="image/x-icon" href="http://centrocultural.cc/discoteca/wp-admin/images/favicon.ico">
				...
				<?php
					...
					if(isset($zerif_logo) && $zerif_logo != ""):
						...
						echo ' <a class="navbar-brand navbar-brand-logotext" href="'.esc_url( home_url( '/' ) ).'">
								<img src="'.get_template_directory_uri().'/images/logo.png"></a>'
				?>
